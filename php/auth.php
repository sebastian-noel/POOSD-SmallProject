...
// Sessions are how we know who's logged in. SameSite=Lax + Secure works for
// same-origin AJAX calls over HTTPS (required once this is on a real domain).
...
// Returns the current user's id. The frontend never supplies its own
// user id -- it always comes from the session, so nobody can read or
// modify another user's contacts by passing a different id.
